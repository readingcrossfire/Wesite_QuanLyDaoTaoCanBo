...
<head>
    ...
    <title>Cập Nhật Kết Quả Khóa Học</title>
</head>
<style>
    *,
    html {
...
<div class="container-fluid cContainerFluid">
    <div class="row cRow">
        <div class="col-3 col-md-3 cColNavbarLeft">
        ...
        <div class="col-8 col-md-8 cColContent">
            <div class="theCourse">
                ...
                <span class="title">Cập nhật Kết Quả khoá học</span>
        ...
        submit.click(function()
        {
            ...
            $("form").on('submit', function (e) {
                ...
                $.ajax({
                    ...
                    data : JSON.stringify({
                        tencanbo:tencanbo,
                        ketquakhoahoc:ketquakhoahoc,
                        chucvu:chucvu,
                        tenlop:tenlop,
                        giangviendaotao:giangviendaotao,
