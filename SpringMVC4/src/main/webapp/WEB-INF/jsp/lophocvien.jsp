    ...
    <div class="row cRow">
        <div class="col-md-3 cColNavbarLeft">
            ...
            <div class="cColNavbarLeft__panelTitle">
                <span class="title"><a href="./lophocvien.jsp">Quản lý đào tạo cán bộ</a></span>
            </div>
            <hr />
            ...
            <div class="theCourse">
                ...
                <div class="boxBorder boxFunction">
                    <button type="button" class="btn btn-primary">
                        <a href="them-hoc-vien" style="text-decoration: none;color: white;">Thêm Lớp Học viên</a>
                    </button>
                    <div class="boxSearch">
                        <input
                                type="email"
                ...
                <div class="boxBorder">
                    <table class="table table-striped">
                        ...
                        "
                                >
                                    <button>
                                        <a href="chi-tiet-lop-hoc-vien" style="color: black;"><i class="fas fa-align-justify fa-lg"></i></a>
                                    </button>
                                    <button >
                                        <a style="color: black;" href="cap-nhat-lop-hoc-vien"><i class="fas fa-pen-alt fa-lg"></i></a>
                                    </button>
                                    <button>
